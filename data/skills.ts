...
export const skillGroups: SkillGroup[] = [
  {
    ...
    technologies: ["C", "C++", "C#", "Python", "JavaScript", "TypeScript"],
  },
  {
    ...
    technologies: ["React", "Next", "Tailwind CSS", "HTML5", "CSS3"],
  },
  {
    ...
    technologies: ["Node", "Express", "Nest", "REST API", "GraphQL"],
  },
  {
    ...
    technologies: ["PostgreSQL", "MySQL", "MongoDB", "Supabase", "Type ORM", "Prisma ORM"],
  },
  {
    categoryName: "DevOps",
    category: "devops",
