...
export default function InputSearch() {
  return (
    <>
      ...
      <Button className='focus-visible:ring-ring border-input hover:bg-accent hover:text-accent-foreground bg-muted/50 text-muted-foreground relative hidden h-8 w-36 items-center justify-between gap-2 rounded-[0.5rem] border px-4 py-2 text-sm font-normal whitespace-nowrap shadow-none transition-colors focus-visible:ring-1 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 sm:inline-flex md:w-40 lg:w-56 xl:w-64'>
        <FaSearch />
